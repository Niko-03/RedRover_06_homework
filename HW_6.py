...
6.3 (от Дениса)  Реализовать свой стек (это упорядоченная коллекция элементов, организованная по типу ....... последний пришёл - первый вышел)
                 И надо реализовать класс .................... дальше не оч.понятно... текстового варианта нет
'''
